...
<?php //$form->field($model->user->userAccount, 'bank_address')->textInput(['disabled' => 'disabled', 'value' => $model->user->userAccount->address . ' ' . $model->user->userAccount->bank_address]) ?>
