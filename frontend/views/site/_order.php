    <style type="text/css">
    .createchoose-wrap{
        background-image:url(/images/die.png) no-repeat center center;
    }
    </style>
    <div class="transaction transaction1 orderContent">
        ...
        <div id="createorderbox">
            <div class="createorder-content">
                <div class="createchoose-wrap <?php if($string == '涨'){echo 'up';}else{echo 'down';}?>" <?= $class ?>>建仓看<?= $string ?></div>
                ...
                <div class="key-value boxflex">
                    ...
                    <div style="margin-top: 10px;color: #aaa;">最大下单数量<?= $product['max_hand'] ?>手</div>
                </div>
<!--                 <div class="key-value boxflex">
